...
export class DiagnosticsClient {
     ...
     *
     * @param {LoonFS.maintenance.GetNamespaceDiagnosticsRequest} request
     ...
     *
     * @example
     *     await client.maintenance.diagnostics.retrieve({
     *         namespace_id: "namespace_id"
     *     })
     */
    public retrieve(
        request: LoonFS.maintenance.GetNamespaceDiagnosticsRequest,
    ...
    private async __retrieve(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `v0/maintenance/namespaces/${core.url.encodePathParam(namespaceId)}/diagnostics`,
            ),
            method: "GET",
            headers: _headers,
