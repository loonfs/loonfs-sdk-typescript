...
export class GrepIndexClient {
     ...
     *
     * @param {LoonFS.maintenance.GetGrepIndexRequest} request
     ...
     *
     * @example
     *     await client.maintenance.grepIndex.retrieve({
     *         namespace_id: "namespace_id"
     *     })
     */
    public retrieve(
        request: LoonFS.maintenance.GetGrepIndexRequest,
    ...
    private async __retrieve(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `v0/maintenance/namespaces/${core.url.encodePathParam(namespaceId)}/grep/index`,
            ),
            method: "GET",
            headers: _headers,
     ...
     *
     * @example
     *     await client.maintenance.grepIndex.disable({
     *         namespace_id: "namespace_id"
     *     })
     */
    public disable(
        request: LoonFS.maintenance.DisableGrepIndexRequest,
        requestOptions?: GrepIndexClient.RequestOptions,
    ): core.HttpResponsePromise<LoonFS.GrepIndex> {
    ...
    private async __disable(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)),
                `v0/maintenance/namespaces/${core.url.encodePathParam(namespaceId)}/grep/index/disable`,
            ),
            method: "POST",
            headers: _headers,
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
     ...
     *
     * @example
     *     await client.maintenance.grepIndex.enable({
     *         namespace_id: "namespace_id"
     *     })
     */
    public enable(
        request: LoonFS.maintenance.EnableGrepIndexRequest,
        requestOptions?: GrepIndexClient.RequestOptions,
    ): core.HttpResponsePromise<LoonFS.GrepIndex> {
    ...
    private async __enable(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)),
                `v0/maintenance/namespaces/${core.url.encodePathParam(namespaceId)}/grep/index/enable`,
            ),
            method: "POST",
            headers: _headers,
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
